...
/*Save ali mesh bond and control information*/
#define FLASH_ALI_START_ADDRRESS	(0)//(APP_START_ADDR)
/*Save ali mesh timer configure*/
#define FLASH_ALI_TIMER_ADDRRESS	(FLASH_ALI_START_ADDRRESS+PAGE_SIZE)

/*The total flash pages used by ali Genie*/
#define FLASH_ALI_USED_PAGE_SIZE	(2)
