 ...
 ****************************************************************************************
 */
__INLINE_S__ uint16_t co_htons(uint16_t hostshort)
{
    #if (!CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_ntohl(uint32_t netlong)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_ntoh24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint16_t co_ntohs(uint16_t netshort)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_htob24(uint32_t val24)
{
    #if (CPU_LE)
        return val24;
    #else
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_htobl(uint32_t hostlong)
{
    #if (CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint16_t co_htobs(uint16_t hostshort)
{
    #if (CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_btoh24(uint32_t val24)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_btohl(uint32_t btlong)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint16_t co_btohs(uint16_t btshort)
{
