...
//#include "compiler.h"      // for __INLINE_S__
#include "co_com.h"
 ...
 ****************************************************************************************
 */
__INLINE_S__ void co_random_init(uint32_t seed)
{
    srand(seed);
}
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint8_t co_rand_byte(void)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint16_t co_rand_hword(void)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_rand_word(void)
{
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_min(uint32_t a, uint32_t b)
{
    return a < b ? a : b;
}
 ...
 ****************************************************************************************
 */
__INLINE_S__ int32_t co_min_s(int32_t a, int32_t b)
{
    return a < b ? a : b;
}
 ...
 ****************************************************************************************
 */
__INLINE_S__ uint32_t co_max(uint32_t a, uint32_t b)
{
    return a > b ? a : b;
}
 ...
 ****************************************************************************************
 */
__INLINE_S__ int co_abs(int val)
{
