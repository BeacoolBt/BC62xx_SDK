...
#include <string.h>         // For use of memcpy and memset functions
#include "port.h"
#include "co_com.h"
/*
 * ENUMERATIONS
 ...
 ****************************************************************************************
 */
#define M_AL_MSG_ALLOC(msg_id, type)            ((type *)m_al_msg_alloc((msg_id), sizeof(type)))
 ...
 ****************************************************************************************
 */
#define M_AL_MSG_ALLOC_DEFAULT(msg_id)          (m_al_msg_alloc((msg_id), 0))
 ...
 ****************************************************************************************
 */
#define M_AL_MSG_ALLOC_DYN(msg_id, type, len)  ((type *)m_al_msg_alloc((msg_id), sizeof(type) + len))
...
typedef struct m_al_adv_cb m_al_adv_cb_t;
/// Connection callback set
typedef struct m_al_con_cb m_al_con_cb_t;
 ...
 ****************************************************************************************
 */
typedef uint8_t (*m_al_msg_handler) (uint16_t msg_id, uint16_t src_id, const void* p_param);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_sec_aes_res_cb) (const uint8_t* p_aes_res);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_sec_ecdh_secret_res_cb) (uint16_t status, const uint8_t* p_ecdh_secret);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_sec_pub_key_res_cb) (uint16_t status, const uint8_t* p_pub_key_x, const uint8_t* p_pub_key_y);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_sec_aes_ccm_cb) (bool mic_error);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_adv_sent_cb) (m_lid_t bearer_lid, uint16_t status);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_adv_rx_cb) (m_lid_t bearer_lid, uint16_t status, int8_t rssi, uint8_t adv_len, const uint8_t* p_data);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_adv_scan_op_cb) (m_lid_t bearer_lid, uint16_t status);
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_adv_scan_start_api) (m_lid_t bearer_lid, uint16_t interval, const m_al_adv_cb_t* p_cb_evts);
/**
 ****************************************************************************************
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_adv_scan_stop_api) (m_lid_t bearer_lid);
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_adv_send_api) (m_lid_t bearer_lid, uint16_t interval, uint8_t nb_tx,
 ...
 *
 * @param[in] con_type      Type of connection (@see enum m_al_con_type)
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_con_start_api) (uint8_t con_type, uint16_t interval, uint16_t data_len, const uint8_t* p_data,
                                        const m_al_con_cb_t* p_cb_evts);
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_con_stop_api) (void);
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_con_update_api) (uint16_t data_len, const uint8_t* p_data);
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_con_close_api) (m_lid_t bearer_lid);
 ...
 ****************************************************************************************
 */
typedef uint16_t (*m_al_con_send_api) (m_lid_t bearer_lid, uint8_t type, uint16_t data_len, const uint8_t *p_data);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_con_op_cb) (uint16_t status);
 ...
 ****************************************************************************************
 */
typedef m_lid_t (*m_al_con_created_cb)(uint8_t conidx);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_con_closed_cb)(m_lid_t bearer_lid, uint8_t reason);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_con_msg_rx_cb)(m_lid_t bearer_lid, uint8_t type, uint8_t data_len, const uint8_t* p_data);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_con_msg_sent_cb)(m_lid_t bearer_lid, uint16_t status);
 ...
 ****************************************************************************************
 */
typedef void (*m_al_djob_cb)(void* p_env);
...
/// Advertising callback set
typedef struct m_al_adv_cb
{
    /// Scan started status
    m_al_adv_scan_op_cb start_cb;
    /// Scan stopped status
    m_al_adv_scan_op_cb stop_cb;
    /// Advertising report reception
    m_al_adv_rx_cb      rx_cb;
    /// Advertising packet properly sent
    m_al_adv_sent_cb    sent_cb;
} m_al_adv_cb_t;


/// Structure for Advertising Abstraction Layer API
typedef struct m_al_adv_api_
{
    /// Start scanning operation
    m_al_adv_scan_start_api  scan_start;
    /// Stop scanning operation
    m_al_adv_scan_stop_api   scan_stop;
    /// Send Advertising packet function
    m_al_adv_send_api        send;
} m_al_adv_api_t;


#if (BLE_MESH_GATT_BEARER)
/// Structure for Connection Abstraction Layer API
typedef struct m_al_con_api_
{
    /// Start connection bearer
    m_al_con_start_api  con_start;
    /// Stop all connectable bearer
    m_al_con_stop_api   con_stop;
    /// Close a specific connection
    m_al_con_close_api  con_close;
    /// Send packet over connection
    m_al_con_send_api   send;
} m_al_con_api_t;
#endif // (BLE_MESH_GATT_BEARER)

/// Connection callback set
typedef struct m_al_con_cb
{
    /// Connection operation started status
    m_al_con_op_cb        start_cb;
    /// Connection operation stopped status
    m_al_con_op_cb        stop_cb;
    /// Connection Creation
    m_al_con_created_cb   created_cb;
    /// Connection Deleted
    m_al_con_closed_cb    closed_cb;
    /// Message received over proxy or provisioning service
    m_al_con_msg_rx_cb    rx_cb;
    /// Message sent over proxy or provisioning service
    m_al_con_msg_sent_cb  sent_cb;
} m_al_con_cb_t;


/// Job element structure
typedef struct m_al_djob
{
    /// List element header
    co_list_hdr_t hdr;
...
/// Advertising API
extern const m_al_adv_api_t m_al_adv_api;


#if (BLE_MESH_GATT_BEARER)
/// Connection API
extern const m_al_con_api_t m_al_con_api;
#endif // (BLE_MESH_GATT_BEARER)
 ...
 */
#if 0
uint16_t m_al_msg_src_id_get(const void* p_msg);
#endif

/**
 ****************************************************************************************
 * @brief Get profile source identifier
 ****************************************************************************************
 */
#if 0
uint16_t m_al_local_id_get(void);
#endif
/**
 ****************************************************************************************
...
/**
 ****************************************************************************************
 * @brief Get delay value (in milliseconds) to provide to m_al_timer_set function in order
 * to program a timer.
 *
 ...
 *
 * @return M_ERR_NO_ERROR if delay has been properly computed,
 *         M_ERR_TIME_PAST if provided expiration time is in the past
 *         M_ERR_INVALID_PARAM if provided expiration time is too far in the future to compute
 * a delay value.
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Handler of message that can be handled by the Mesh API
 * This function is access externally by the m_al_task.c
 *
 * @param[in] msg_id  Message identifier
 * @param[in] src_id  Identifier of the task that issue message
 * @param[in] p_param Parameters of the message received
...
/**
 ****************************************************************************************
 * @brief Mesh memory requirements
 *
 * @note this function is called before init function in order to know memory requirements
 *
 * @param[in] p_cfg    Pointer to mesh stack initialization parameters
 *
 * @return Size of environment required for mesh
 ****************************************************************************************
 */
