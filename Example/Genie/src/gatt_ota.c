...
{
	//set adv resp data
	//uint8_t _data[] = {0x07, 0x09, 0x5a, 0x58, 0x2d, 0x4f, 0x54, 0x41, 0x07, 0xff, 'B', 'C', '6', '2', '1', '8'};
	/*adv data 02 01 05 07 09 5a 58 2d 4f 54 41 ff BC6218 mac ver*/
	uint8_t _data[13+6+6+5] = {0x02, 0x01, 0x02, 0x07, 0x09, 0x5a, 0x58, 0x2d, 0x4f, 0x54, 0x41, 0x0c+6, 0xff, 'B', 'C', '6', '2', '1', '8'};
	ali_config_mac_read(_data+19, 0);
	memcpy(_data+25, MESH_VER, strlen(MESH_VER));
